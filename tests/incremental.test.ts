...
import { extractHandlers, injectHandlers, PY_DEFAULT_STUB_PATTERN, TS_DEFAULT_STUB_PATTERN } from "../src/core/incremental";
...
const languages = [
  ...
  { lang: "go", prefix: "//", indent: "\t\t", code: ['message := "preserved"', 'return message'], stub: 'return "default"', pattern: PY_DEFAULT_STUB_PATTERN },
